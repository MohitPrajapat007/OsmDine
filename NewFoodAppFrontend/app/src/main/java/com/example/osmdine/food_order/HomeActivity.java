...
import com.example.osmdine.food_order.ViewHolders.MenuViewHolder;
...
//        recyclerView_menu.setLayoutManager(new LinearLayoutManager(this, VERTICAL, false));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_restaurant) {
            ...
            Paper.book(Common.CLIENT).delete(Common.USER_PHONE);
            Paper.book(Common.CLIENT).delete(Common.USER_PASSWORD);
            Paper.book(Common.CLIENT).delete(Common.USER_NAME);
