                        ...
                        if(dataSnapshot.child(editPhone.getText().toString()).exists())
                        {
                            ...
                            if(Boolean.parseBoolean(user.getIsStaff()))
                            {
                                if (user.getPassword().equals(editPassord.getText().toString())) {
                                    ...
                                    {
                                        Paper.book(Common.SERVER).write(Common.USER_PHONE, editPhone.getText().toString());
                                        Paper.book(Common.SERVER).write(Common.USER_PASSWORD, editPassord.getText().toString());
                                        Paper.book(Common.SERVER).write(Common.USER_NAME, user.getName());
                                    }
