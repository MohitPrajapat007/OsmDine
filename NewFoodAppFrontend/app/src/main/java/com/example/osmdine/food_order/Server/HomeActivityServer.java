package com.example.osmdine.food_order.Server;
...
import com.example.osmdine.food_order.Model.Category;
import com.example.osmdine.food_order.Interface.ItemClickListener;
import com.example.osmdine.food_order.R;
import com.example.osmdine.food_order.Server.ViewHolders.MenuViewHolderServer;
...
public class HomeActivityServer extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_sign_out)
        {
            ...
            Paper.book(Common.SERVER).delete(Common.USER_PHONE);
            Paper.book(Common.SERVER).delete(Common.USER_PASSWORD);
            Paper.book(Common.SERVER).delete(Common.USER_NAME);
